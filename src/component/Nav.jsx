  ...
  return (
    <>
      <div className="w-screen">
        <div className="flex justify-between shadow-md shadow-gray-400 bg-[#f1f3f4] dark:bg-black dark:text-white  max-sm:text-[10px] w-full      ">
          <a href="https://rcoem-gdsc.netlify.app/" className="flex text-[#8b8b8b] dark:text-white ">
           { !toggle?<img
            ...
            <h1 className="flex justify-center items-center cursor-default">GDG RCOEM</h1>
          </a>
          ...
          <div class="group text-[#5f5f5f] pr-5 dark:text-white  transition duration-300 font-medium flex   " >
          
         <label for="check" className={`${!toggle?"bg-[#7a7a7a]":"bg-white"} relative w-16 h-8 border-2 rounded-full cursor-pointer `}>
